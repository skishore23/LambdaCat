...
def product(C: Cat, obj1: str, obj2: str) -> Limit | None:
...
def equalizer(C: Cat, f: str, g: str) -> Limit | None:
...
def terminal_object(C: Cat) -> str | None:
...
def initial_object(C: Cat) -> str | None:
